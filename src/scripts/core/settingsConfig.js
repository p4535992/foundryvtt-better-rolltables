...
class BetterRolltableSettingsConfig extends FormApplication {
  ...
  _onResetDefaults(event) {
    event.preventDefault();
    const resetOptions = event.currentTarget.form.querySelectorAll(
      '.tab.active .settings-list [data-default]'
    );
    for (let input of resetOptions) {
      if (input && input.type === 'checkbox')
        input.checked = input.dataset.default;
      ...
      tabs: [
        {
          name: GROUP_DEFAULT,
          description: i18n(
            'BRT.Settings.Module.AdvancedSettings.Menu.Base.Description'
          ),
          i18nName: i18n(
            'BRT.Settings.Module.AdvancedSettings.Menu.Base.Title'
          ),
          class: 'fas fa-table',
          menus: [],
          settings: [],
        },
        {
          name: GROUP_UI,
          description: i18n(
            'BRT.Settings.Module.AdvancedSettings.Menu.UI.Description'
          ),
        ...
        },
        {
          name: GROUP_LOOT,
          description: i18n(
            'BRT.Settings.Module.AdvancedSettings.Menu.Loot.Description'
          ),
          i18nName: i18n(
            'BRT.Settings.Module.AdvancedSettings.Menu.Loot.Title'
          ),
          class: 'fas fa-cog',
          menus: [],
          settings: [],
        },
        {
          name: GROUP_TAGS,
          description: i18n(
            'BRT.Settings.Module.AdvancedSettings.Menu.Tags.Description'
          ),
          i18nName: i18n(
            'BRT.Settings.Module.AdvancedSettings.Menu.Tags.Title'
          ),
          class: 'fas fa-tags',
          menus: [],
          settings: [],
