    ...
    getTabData() {
        return {
            tabs: [
                {
                    name: GROUP_DEFAULT,
                    description: Logger.i18n(
                        `${CONSTANTS.MODULE_ID}.Settings.Module.AdvancedSettings.Menu.Base.Description`,
                    ),
                ...
                },
                {
                    name: GROUP_UI,
                    description: Logger.i18n(
                        `${CONSTANTS.MODULE_ID}.Settings.Module.AdvancedSettings.Menu.UI.Description`,
                    ),
                ...
                },
                {
                    name: GROUP_LOOT,
                    description: Logger.i18n(
                        `${CONSTANTS.MODULE_ID}.Settings.Module.AdvancedSettings.Menu.Loot.Description`,
                    ),
                ...
                },
                {
                    name: GROUP_TAGS,
                    description: Logger.i18n(
                        `${CONSTANTS.MODULE_ID}.Settings.Module.AdvancedSettings.Menu.Tags.Description`,
                    ),
