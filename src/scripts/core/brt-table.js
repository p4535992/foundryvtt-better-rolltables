...
export class BetterRollTable extends RollTable {
  ...
  //     const qtFormula = getProperty(r, `flags.${CONSTANTS.MODULE_ID}.${CONSTANTS.FLAGS.RESULTS_FORMULA_KEY_FORMULA}`)?.trim();
