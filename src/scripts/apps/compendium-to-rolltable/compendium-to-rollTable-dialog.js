...
export class CompendiumToRollTableDialog extends Dialog {
            ...
            buttons: {
                proceed: {
                    ...
                    callback: async (html) => {
                        ...
                        await this.fromCompendium(customFilters, nameFilters, selectedItems, selectedSpellLevels, selectedRarities, weightPredicate, compendium);
    ...
    async fromCompendium(customFilters, nameFilters, selectedItems, selectedSpellLevels, selectedRarities, weightPredicate, compendium, options = {}) {
        ...
        await this.createCompendiumFromData(compendium.metadata.label, results, `1d${results.length}`, options);
    }
