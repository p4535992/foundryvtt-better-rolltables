...
export class BetterChatCard {
    ...
    async prepareCharCart(table) {
        ...
        // TODO DO NOT UNDERSTAND WHY IS STOPPED WORKING ON V12
        const cardHtml = await this.renderMessage(chatCardData);
        // let cardHtml = `
        // <div class="table-draw" data-table-id="${chatCardData.id}" data-pack="${chatCardData.compendium}" data-id="${chatCardData.id}">
        //     ${chatCardData.gmTitleLabel ? `<div class="table-title">${gmTitleLabel}</div>` : `` }
        //     ${chatCardData.htmlDescription ? `<div class="table-title">${htmlDescription}</div>` : `` }
        ...
        //                 itemDataHTML = `<li class="table-result flexrow" data-result-id="${itemData.item._id}" data-result-uuid="">
        //                     <img class="result-image" src="modules/better-rolltables/assets/artwork/unidentified-result.webp">
        //                     <div class="result-text">${Logger.i18n("better-rolltables.label.tableResultTextHiddenOnChat")}</div>
        //                 </li>`
        //             } else {
        //                 itemDataHTML = `<li class="table-result flexrow" data-result-id="${itemData.item._id}" data-result-uuid="">
        //                         <img class="result-image" src="${itemData.item.img}">
        //                         <div class="result-text">${itemData.item.text}
        //                             ${ itemData.quantity > 1 ? `<strong>&nbsp; &#xD7; ${itemData.quantity}</strong>` : ``}</div>
        //                     </li>`
        //             }
        //             break;
        //         }
        ...
        //                         data-tooltip="Better Item">
        //                             <i class="fas {{entity-icon itemData.documentName}}"></i> ${Logger.i18n("better-rolltables.label.tableResultTextHiddenOnChat")}
        //                         </a>
        //                         {{#ifgt itemData.quantity 1 }}<strong>&nbsp; &#xD7; {{itemData.quantity}}</strong>{{/ifgt}}
        //                     </div>
        //                 </li>`
        //             } else {
        //                 itemDataHTML = `<li class="table-result flexrow" data-result-id="{{ itemData.item._id }}" data-result-uuid="{{itemData.item.uuid}}">
        //                             <img class="result-image" src="{{itemData.item.img}}">
        //                             <div class="result-text" style="font-size: {{itemData.fontSize}}%;">
